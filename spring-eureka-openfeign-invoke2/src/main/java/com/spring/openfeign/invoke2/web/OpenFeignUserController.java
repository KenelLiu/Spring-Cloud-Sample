package com.spring.openfeign.invoke2.web;

import com.spring.config.IConfig;
import com.spring.openfeign.invoke2.feign.user.UserFeignServiceClient;
import com.spring.openfeign.invoke2.service.log.LogService;
